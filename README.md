...
## Observability (home-infra CONVENTIONS.md §18)
...
systemd unit is a `home-infra`-side change (`config.alloy`'s Lane B allow-list plus
...
`home-infra`'s `alert-rules.yml`, also not added by this change.
