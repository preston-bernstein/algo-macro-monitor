...
- Vault doc `Development/Research/codebase-quality-polish-skill.md` (refreshed same-day for this
  ...
  (internal-infra `CONVENTIONS.md` §18) — the observability lens audited *coverage* of that existing
...
- `log.py`/`metrics.py`'s design — already the result of a deliberate 2026-08-01 §18-conformance
  ...
  design.
- `ops/paper_db_snapshot.py`'s lack of logging — runs outside this package (as the `internal-research-service`
